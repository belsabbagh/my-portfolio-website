...
const featuredProjects: FeaturedProject[] = [
    {
        ...
        description: 'A script that can be used to recognize a hand shape in an image.',
        tags: ['Python', 'OpenCV'],
        href: 'https://github.com/belal-elsabbagh/hand-geometry-detection.git'
    },
    {
        title: 'Productivity Manager',
        description: 'A web app built to keep track of employee utilization on department projects.',
